...
enum RouterVersion {
  SwitchV2Router01 = 'SwitchV2Router01',
  SwitchV2Router02 = 'SwitchV2Router02'
}

describe('SwitchV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.SwitchV2Router01]: fixture.router01,
        [RouterVersion.SwitchV2Router02]: fixture.router02
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SwitchV2Router01]: 101876,
              [RouterVersion.SwitchV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
